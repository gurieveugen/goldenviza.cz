...
function et_divi_load_scripts_styles(){
	...
	wp_enqueue_style('vitaliy-fonts',  TDU.'/css/fonts/stylesheet.css');
}
...
function et_divi_add_customizer_css(){ ?>
	<style>
		...
		.woocommerce .star-rating span:before, .woocommerce-page .star-rating span:before, .et_pb_widget li a:hover, .et_pb_bg_layout_light .et_pb_promo_button,  .et_pb_filterable_portfolio .et_pb_portfolio_filters li a.active, .et_pb_filterable_portfolio .et_pb_portofolio_pagination ul li a.active, .et_pb_gallery .et_pb_gallery_pagination ul li a.active, .wp-pagenavi span.current, .wp-pagenavi a:hover, .et_pb_contact_submit, .et_pb_bg_layout_light .et_pb_newsletter_button, .nav-single a, .posted_in a { color: <?php echo esc_html( et_get_option( 'accent_color', '#2EA3F2' ) ); ?> !important; }
					...
					<div class="et_pb_portfolio_image <?php esc_attr_e( $orientation ); ?>">
						<a href="<?php the_permalink(); ?>">
							...
							<div class="meta">
								...
								<?php if ( 'on' === $show_title ) : ?>
									<h3><?php the_title(); ?>
                                <br><br><span class="ovbutton">Заказать</span></h3>                                    
								<?php endif; ?>
